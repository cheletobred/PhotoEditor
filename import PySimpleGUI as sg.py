...
def image_flip():
    ...
    for drawing in drawings:
        ...
        working_space.create_oval(new_x1, new_y1, new_x2, new_y2, fill=pen_color, outline="", width=pen_size, tags="drawing")
pen_size = 3
pen_color = "black"
draw_enabled = False
def draw(event):
    ...
    if filepath and draw_enabled:
        ...
        working_space.create_oval(x1, y1, x2, y2, fill=pen_color, outline="", width=pen_size, tags="drawing")
def toggle_draw():
    global draw_enabled
